...
def predict_model(data):
    ...
    # 모델 및 인코더, 스케일러 불러오기
    model = load_model(resource_path('model_artifacts/CNN_multi_class.h5'))
    le_protocol = joblib.load(resource_path('model_artifacts/le_protocol_type2.pkl'))
    le_service = joblib.load(resource_path('model_artifacts/le_service2.pkl'))
    le_flag = joblib.load(resource_path('model_artifacts/le_flag2.pkl'))
    scaler = joblib.load(resource_path('model_artifacts/scaler2.pkl'))
    le_label = joblib.load(resource_path('model_artifacts/le_label2.pkl'))
